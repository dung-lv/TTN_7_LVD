...
namespace QuanLyThuVien.Service
{
    class DocGiaService
    {
        ...
        {
            // sql = "Update tblDocGia set HOTEN=N'" + docGia.HoTen + "',NGAYSINH='" + docGia.NgaySinh + "',GIOITINH=N'" + docGia.GioiTinh + "',LOP='" + docGia.Lop + "',DIACHI=N'" + docGia.DiaChi + "',EMAIL='" + docGia.Email + "',GHICHU=N'" + docGia.GhiChu + "' where MADG='" + docGia.MaDocGia + "'";
            //connectSer.ThucThiSQLTheoPhiKetNoi(sql);
            sqlCom = new SqlCommand();
            sqlCom.CommandType = CommandType.StoredProcedure;
